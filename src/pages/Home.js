...
export default function Home() {
  return (
    <div className="min-h-screen bg-animate bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 flex flex-col items-center px-4 pt-24 text-center">
      {/* Headline */}
      <h1 className="text-3xl md:text-5xl font-bold text-white drop-shadow-lg mb-4 md:mb-6">
        Supto❤️Shiropa
      </h1>

      {/* Story */}
      <p className="text-sm md:text-lg text-white/90 max-w-xl mb-6">
